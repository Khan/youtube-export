...
class YouTubeExporter(object):
    ...
    # Publish, to archive.org, all videos that have been converted to
    # downloadable format
    @staticmethod
...
def main():
    ...
    parser.add_option("-s", "--step",
        ...
        help="Export step ('convert' or 'publish' currently)",
        default="convert")
    ...
    parser.add_option("-d", "--dryrun",
        ...
        help="Don't start new zencoder jobs or upload to archive.org",
        default=False)

    parser.add_option("--no-archive",
        action="store_false", dest="use_archive", default=True,
        help="Assume the server uses S3 URLs instead of archive.org URLs. "
        "Don't upload to archive.org, and mark as published via API as soon "
        "as videos are converted and stored on S3.")
